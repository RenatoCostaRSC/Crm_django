...
class InfoVenda(models.Model):
    ...
    status_auditoria = models.CharField('Status da Auditoria', max_length = 12, choices = STATUS_AUDITORIA_CHOICE, null = False, blank = False, default = 'PENDENTE')
    status_pos_venda =  models.CharField('Status Pós venda', max_length = 21, choices = STATUS_POS_VENDA_CHOICE, null = False, blank = False, default = 'AGUARDANDO PAGAMENTO')
