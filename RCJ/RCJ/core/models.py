...
class Produto(models.Model):
    ...
    valor = models.models.DecimalField('Valor', max_digits=5, decimal_places=2)
...
class InfoVenda(models.Model):
    ...
    produto = models.OneToOneField("Produto", verbose_name=("Produto"), on_delete=models.CASCADE)
    ...
    status_auditoria = models.CharField('Status da Auditoria', max_length = 12, choices = STATUS_DA_AUDITORIA_CHOICE, null = False, blank = False, default = 'PENDENTE')
    status_pos_venda =  models.CharField('Status Pós venda', max_length = 12, choices = STATUS_POS_VENDA_CHOICE, null = False, blank = False, default = 'AGUARDANDO PAGAMENTO')
    ...
    created_date = models.DateField('Data da venda', auto_add_now = True)
    adesão = models.CharField('Adesão', max_length = 10, null = False, blank = False)
    forma_de_pagamento = models.CharField('Forma de pagamento', max_length = 2, choices = FORMA_DE_PAGAMENTO_CHOICE, null = False, blank = False)
