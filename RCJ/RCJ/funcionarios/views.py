...
from RCJ.funcionarios.forms import FuncionarioForm, EnderecoForm, RgForm, CpfForm, TituloDeEleitorForm
from RCJ.funcionarios.models import Funcionario, Rg, Cpf, TituloDeEleitor, Endereco
...
def delete_funcionario(request, pk, slug):
    template_name = 'funcionarios/delete_funcionario.html'
    funcionario = get_object_or_404(Funcionario, slug = slug)
...
def edit_funcionario(request, pk, slug):
